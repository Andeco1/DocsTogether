...
public class UseCaseConfig {
    @Bean
    public ManageDocumentUseCase manageDocumentUseCase(DocumentRepository documentRepository, DocumentMembershipRepository membershipRepository) {
        return new ManageDocumentUseCase(documentRepository, membershipRepository);
    }
    ...
    @Bean
    public DocumentSharingUseCase documentSharingUseCase(DocumentRepository documentRepository, DocumentMembershipRepository membershipRepository, ShareLinkRepository shareLinkRepository) {
        return new DocumentSharingUseCase(documentRepository, membershipRepository, shareLinkRepository);
    }
}